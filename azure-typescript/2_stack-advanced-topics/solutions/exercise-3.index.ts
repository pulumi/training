...
// Exercise 3 //
// The wrong way - so one can see what the output looks like
export const appUrlWrong = `https://${app.defaultHostName}`;
// Correct way using "interpolate"
export const appUrlUsingInterpolate = pulumi.interpolate`https://${app.defaultHostName}`;
// Correct way using "apply"
export const appUrlUsingApply = app.defaultHostName.apply(hostname => `https://${hostname}`);
