...
class Ex2StorageInfraArgs
{
    public Input<string> ResourceGroupName { get; set; } = null!;
}

class Ex2StorageInfra: Pulumi.ComponentResource
{
    ...
    public Ex2StorageInfra(string name, Ex2StorageInfraArgs args, ComponentResourceOptions? opts = null)
